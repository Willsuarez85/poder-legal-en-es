...
(
  '{"es": "¿Qué necesitas proteger si tú no pudieras actuar?", "en": "What do you need to protect if you could not act?"}',
  'multiple',
...
(
  ...
  'single',
  '{"es": ["Que me ayude en TODO si yo no puedo", "Solo en temas específicos (por ejemplo, solo salud o finanzas)"], "en": ["Help me with EVERYTHING if I cannot", "Only specific topics (for example, only health or finances)"]}',
  3
),
(
  '{"es": "¿Cuándo debería empezar a usarse esta Carta de Poder?", "en": "When should this Power of Attorney start being used?"}',
  'single',
  '{"es": ["Desde el momento en que la firmo", "Solo si hay una emergencia médica y yo no puedo decidir"], "en": ["From the moment I sign it", "Only if there is a medical emergency and I cannot decide"]}',
  4
);
