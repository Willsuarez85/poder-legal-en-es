      ...
      <div className="max-w-2xl mx-auto">
        <Card className="text-center">
          <CardHeader className="space-y-6">
            ...
            <CardTitle className="text-3xl font-bold">¿Cuál Carta de Poder necesitas según tu situación?</CardTitle>
          </CardHeader>
...
Contesta 4 preguntas sencillas y en menos de 2 minutos tendrás acceso a la carta correcta para proteger lo que más amas: tu familia, tus bienes y tu tranquilidad.</p>
